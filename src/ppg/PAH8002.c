...
static uint8_t pah8002_enter_normal_mode() {
...
static uint8_t pah8002_enter_suspend_mode() {
  int i = 0 ;
...
uint8_t pah8002_read_reg(uint8_t addr, uint8_t *data) {
  ...
  //i2c_writeRead(I2C_ID_PAH8002, &addr, 1, data, 1);
  i2c_write(I2C_ID_PAH8002, &addr, 1);
  i2c_read(I2C_ID_PAH8002, data, 1);
...
*/
  ...
  i2c_write(I2C_ID_PAH8002, &addr, 1);
  i2c_read(I2C_ID_PAH8002, data, rx_size);
